...
const Order = () => {
  const { items,isLoading,loadItems,totalCount,allPrice,getAllCountAndPrice } = useStore();
  ...
  return (
    <Container>
      ...
      <Footer>
        ...
        {isLoading ? (
          <Button isLoading={isLoading} onClick={submitOrder} disabled={isLoading}>주문하기</Button>
        ) : (
          <Button onClick={submitOrder} disabled={isLoading}>주문하기</Button>
        )}
